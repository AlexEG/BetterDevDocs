      ...
      <main className="w-full min-h-screen pt-12 max-w-7xl mx-auto pl-64 pr-64 selection:bg-neutral-600 selection:text-neutral-200">
        <article className="bg-neutral-200 w-full min-h-96 rounded-lg p-6">
          ...
          <p>
            ...
            Accusantium alias blanditiis odio ab quidem tempore expedita
            mollitia! Excepturi enim quisquam fugiat impedit odit, possimus
            eligendi, similique cupiditate dolore ratione id tenetur at? Aperiam
            consequatur repudiandae est delectus, ut commodi possimus architecto
            ipsam suscipit nisi repellendus voluptatibus tempore voluptatum
            doloremque, autem molestiae obcaecati non expedita explicabo eaque
            impedit vitae unde aliquam laudantium. Molestiae, minus? Quos
            officiis adipisci, voluptatem vero omnis provident iure earum
            repellat iste nostrum blanditiis inventore est debitis labore
            laborum rem quas. Quasi, vitae perspiciatis facere nam illum, dicta
            quos ab modi, impedit quisquam alias itaque fugit delectus!
            Temporibus adipisci ipsam illo quas, mollitia deleniti praesentium
            aut illum nulla in!
          </p>
          <div className="px-8">
            <img
          ...
          <p>
            ...
            quia, sint at tenetur rerum rem labore architecto quibusdam iure
            fuga quis, incidunt odit quas autem cum eos. Soluta corporis, autem
