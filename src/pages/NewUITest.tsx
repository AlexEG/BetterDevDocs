import LanguagesTools from "../components/navbar/LanguagesTools";
function NewUITest() {
  return (
    <div className="h-screen overflow-hidden">
      <nav className="h-10 bg-neutral-950 flex fixed top-0 w-full left-0 justify-between items-center px-2 z-10 shadow-lg">
