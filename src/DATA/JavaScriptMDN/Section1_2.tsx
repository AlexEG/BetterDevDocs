export default function Section1_2() {
  return (
    <div>
      ...
      <p>
        Welcome to the MDN beginner's JavaScript course! In this article we will
        look at JavaScript from a high level, answering questions such as "What
        is it?" and "What can you do with it?", and making sure you are
        comfortable with JavaScript's purpose.
      </p>
      <h2>A high-level definition</h2>

      <p>
        33333333333333 JavaScript is a scripting or programming language that
        ...
        cake of standard web technologies, two of which (HTML and CSS) we have
